package com.xiaowei.codeservice;


import com.google.common.base.CaseFormat;
import com.xiaowei.codeservice.impl.ControllerGenerator;
import com.xiaowei.codeservice.impl.ModelAndMapperGenerator;
import com.xiaowei.codeservice.impl.ServiceGenerator;
import com.xiaowei.util.StringUtils;
...
public class CodeGeneratorManager extends CodeGeneratorConfig {
	...
	private static void init() {
		...
		JAVA_PROJECT = prop.getProperty("java.project");
		TEMPLATE_PROJECT = prop.getProperty("template.project");
		JAVA_PATH = JAVA_PROJECT+ prop.getProperty("java.path");
		RESOURCES_PATH = JAVA_PROJECT+ prop.getProperty("resources.path");
		TEMPLATE_FILE_PATH = PROJECT_PATH +TEMPLATE_PROJECT+prop.getProperty("template.file.path");
